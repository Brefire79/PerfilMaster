...
export const TESTES_DIRIGIDOS = [
  {
    ...
    itens: [
      ...
      it('td_assert_posicao_04',  'posicao',  'Costumo concordar em público mesmo quando, por dentro, discordo.', true),
      it('td_assert_conflito_01', 'conflito', 'Encaro uma conversa difícil como parte normal do trabalho.'),
      it('td_assert_conflito_02', 'conflito', 'Adio conversas desconfortáveis até que o problema cresça demais.', true),
      it('td_assert_conflito_03', 'conflito', 'Depois de um desentendimento, consigo retomar a relação sem guardar mágoa.'),
  ...
  },
  {
    ...
    itens: [
      ...
      it('td_equil_descanso_01',  'descanso',  'Nas folgas e pausas, consigo me desligar do trabalho de verdade.'),
      ...
      it('td_equil_proposito_04', 'proposito', 'Quando paro para pensar, tenho a sensação de estar correndo sem saber para onde.', true),
    ],
  },
  {
    codigo: 'TD-DECISAO',
    ...
    itens: [
      it('td_decis_agilidade_01',        'agilidade',        'Consigo decidir com informação incompleta quando esperar custaria mais caro.'),
  ...
  },
  {
    ...
    itens: [
      ...
      it('td_foco_conclusao_03', 'conclusao', 'Levo o que começo até a versão final, em vez de parar na ideia ou no protótipo.'),
      ...
      it('td_foco_atencao_04',   'atencao',   'Uma interrupção pequena costuma bastar para eu sair da tarefa.', true),
      it('td_foco_rotina_01',    'rotina',    'Faço bem tarefas repetitivas quando elas fazem parte do resultado.'),
      it('td_foco_rotina_02',    'rotina',    'Fico inquieto quando o dia não tem nada novo.', true),
  ...
  },
  {
    ...
    itens: [
      ...
      it('td_feedb_autocompaixao_04', 'autocompaixao', 'Exijo de mim um padrão bem mais alto do que exijo dos outros.', true),
  ...
  },
  {
    ...
    itens: [
      ...
      it('td_pqbase_recuperacao_04', 'recuperacao', 'Quando estou tenso, fico sem saber como sair disso.', true),
