...
function AvaliadoCard({ avaliado, onWhatsApp, onCopiarLink, onDeletar, onVerResultado, onRelatorio }) {
  ...
  return (
    <div className="flex items-center gap-3 p-3 rounded-xl bg-[#1A1C2A] hover:bg-[#1E2030] transition-colors">
      ...
      {/* Ações — ícone + label de texto (label visível em telas ≥sm; tooltip sempre) */}
      <div className="flex flex-wrap gap-1.5 shrink-0">
        ...
        {avaliado.status === 'concluido' && avaliado.perfil && (
          <>
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-xs font-medium text-[#818CF8] hover:text-white hover:bg-[#6366F1] transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-xs font-medium text-[#22C55E] hover:text-white hover:bg-[#22C55E] transition-colors"
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-4 h-4 shrink-0" aria-hidden="true">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-xs font-medium text-[#A0A3B1] hover:text-[#F7F8FC] hover:bg-[#2D3047] transition-colors"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-xs font-medium hover:bg-[#25D366]/20 transition-colors"
          style={{ color: '#25D366' }}
        >
