...
type Question = { id: string; dimension: Dimension; weight: number; invertido?: boolean };
export const DISC_VERSAO = 2; // DISC-V2

const QUESTIONS: Question[] = [
  { id: 'q_d_01', dimension: 'D', weight: 1.0 }, { id: 'q_d_02', dimension: 'D', weight: 1.0, invertido: true },
  ...
  { id: 'q_i_01', dimension: 'I', weight: 1.0 }, { id: 'q_i_02', dimension: 'I', weight: 1.0, invertido: true },
  ...
  { id: 'q_s_01', dimension: 'S', weight: 1.0 }, { id: 'q_s_02', dimension: 'S', weight: 1.0, invertido: true },
  ...
  { id: 'q_c_01', dimension: 'C', weight: 1.0 }, { id: 'q_c_02', dimension: 'C', weight: 1.0, invertido: true },
  ...
  { id: 'q_d_07', dimension: 'D', weight: 1.1, invertido: true }, { id: 'q_i_07', dimension: 'I', weight: 1.1, invertido: true },
  { id: 'q_s_07', dimension: 'S', weight: 1.1, invertido: true }, { id: 'q_c_07', dimension: 'C', weight: 1.1, invertido: true },
];
...
export function calcularPerfil(respostas: Record<string, number>) {
  ...
  for (const [questionId, valor] of Object.entries(respostas || {})) {
    ...
    const ajustado = q.invertido ? 6 - bruto : bruto; // DISC-V2
