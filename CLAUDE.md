...
- **Falta (próxima etapa)**: aplicar o teste pelos 3 canais (wizard/link/turma), pontuar no servidor, persistir em `app_ciclos` + eventos `cycle_*` no `audit_log`, card por turma no Comparativo.
